...
const Card = ({ title, categories, content, created_at,imgurl }: CardProps) => {
  return (
    <HStack
      p={{ base: 3, sm: 6 }}
    ...
    >
      <Image src={imgurl} h={50} width={50} />
      <Box>
